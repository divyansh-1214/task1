    ...
    return (
        <>
            <div className=' grid justify-center items-center  w-screen h-screen overflow-x-auto'>
                ...
                <div className='canvas mx-5 text-center justify-center grid grid-flow-col  grid-cols-4 grid-rows-4 gap-5 md:grid-rows-3 md:grid-cols-7' style={{ height: '50rem', width: '50rem' }}>
                    <div className=' bg-purple-300 rounded-3xl relative  row-span-2 col-span-2 md:col-span-3' onMouseEnter={handle11} onMouseLeave={handle12}>
                        <h1 className='flex pt-4 px-4 text-2xl justify-start'>Customization</h1>
                    ...
                    <div className=' bg-orange-300 col-span-2 md:col-span-5 rounded-3xl flex overflow-hidden'>
                        <div className='w-[10rem]'>
                            <h1>Send Gifts</h1>
                            <p>Send as a group with friends or individually</p>
                        </div>
                        <div className='grid grid-cols-3 w-80   relative ' style={{ transform: 'rotate(-20deg)' }}>
                            <div className='absolute top-5 left-0 m-5'>
                            ...
                            <div className='absolute top-[-2rem] left-32 px-5'>
                            ...
                            <div className='absolute w-64 left-64 px-8'>
                    ...
                    <div className=' bg-red-300 col-span-4 relative rounded-3xl' onMouseEnter={handle31} onMouseLeave={handle32}>
                        <div className='relative'>
                        ...
                        <div className='absolute justify-start text-start bottom-0'>
                            <h1 className='text-lg p-2'>Scheduling</h1>
                            <p className='w-44 '>Schedule all your cards and gifts now and we’ll send them later</p>
                        </div>
                    </div>
                    <div className=' bg-green-200 col-span-2 grid grid-rows-2 rounded-3xl' onMouseEnter={handlein4} onMouseLeave={handleout4}>
                    ...
                    <div className=' bg-yellow-300 col-span-2 grid grid-rows-2 px-4 overflow-hidden rounded-3xl' onMouseEnter={handlein5} onMouseLeave={handleout5}>
                        <div className='justify-start text-start'>
                            <h1>Inbox</h1>
                    ...
                    <div className=' bg-gray-400 col-span-2 rounded-3xl grid grid-rows-2 overflow-hidden pl-4' onMouseEnter={handlein6} onMouseLeave={handleout6}>
